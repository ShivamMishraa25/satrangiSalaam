...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO articles (title, name, contact, content) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("ssss", $title, $name, $contact, $content);
    $stmt->execute();
    $stmt->close();

    // Redirect to the WriteArticle.php page
    header('Location: ../public/writeArticle');
    exit();
}
?>
...
<meta property="og:title" content="Article Writing">
<meta property="og:description" content="Compose Your Article to be displayed on our official website. Your article will be publlished within 24 hours.">
...
<!--  <meta property="og:url" content="http://satrangisalaam.in">  -->
    ...
    <label for="content">Your Article:</label><br>
    <textarea id="content" name="content" rows="10" maxlength="5000" placeholder="5000 words max..." required></textarea><br><br>
    
    <label for="name">Your Name:</label><br>
    <input type="text" id="name" name="name" required><br><br>

    <label for="contact">Your Contact:</label><br>
    <input type="text" id="contact" name="contact" placeholder="either Phone or Email" required><br><br>

    <input type="submit" value="Submit Article">
</form>
<br><br>
<p>आपके आर्टिकल मॉडरेटर द्वारा अप्प्रूव होने पर <sapn class="highlight">आर्टिकल पेज पर प्रकाशित होंगे|</span></p>
          </section>
        <footer>
            <ul>
