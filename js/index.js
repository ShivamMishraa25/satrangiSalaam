// DONT THINK THIS FILE IS NEEEDED ANYMORE (COZ IT WAS FOR THE OLD HOMEPAGE)
// (BIRD AND THEME IS HERE. NEVERMIND)
...
function handleScrollAnimations() {
    ...
    animatedElements.forEach(element => {
        ...
        if (elementTop < windowHeight - 100 && elementBottom > 100) {
            ...
            // Remove 'visible' class when the element is out of view
...
window.addEventListener('load', handleScrollAnimations); // Trigger on page load
