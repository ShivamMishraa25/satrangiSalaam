...
<meta property="og:description" content="Make your career with Satrangi Salaam">
...
<!--  <meta property="og:url" content="http://satrangisalaam.in">  -->
    ...
    <body>
        ...
        <img id="bird2" src="../img/bird2.png" alt="flying bird">
          ...
          <h1>करियर (पेशेवर) विकास के अवसर</h1>
<br><br>
          <a href="experience_form.php" class="button">एक्सपीरियंस सर्टिफ़िकेट के लिए अप्लाई करें (Experience Certificate)</a><br><br>
          <a href="participation_form.php" class="button">पार्टिसपेशन सर्टिफ़िकेट के लिए अप्लाई करें (Participation Certificate)</a>
          <br><br>      
          <div class="left">
        <p>आप सतरंगी सलाम से जुड़ करके विभिन्न प्रकार के हुनर सीख सकते हैं।</p><br/>
        <p>हम लगातार विभिन्न प्रकार की गतिविधियाँ संचालित करते रहते हैं, जिसमें आप अपने हुनर को दिखा और निखार सकते हैं।</p><br/>
        <div class="highlight">
            <p>अगर आप पर्यावरण के लिए कुछ करना चाहते थे लेकिन किसी प्रकार की हिचक के कारण नहीं कर पाए, तो सतरंगी सलाम में आप यह मौका पा सकते हैं।</p>
        </div><br/>
        <p>आपको जिस भी क्षेत्र में रुचि हो - लिखना, ब्लॉगिंग, मेहंदी, डांस, गाना, पढ़ाना-सिखाना, इवेंट प्लानिंग, कस्टमर केयर या कुछ और... सतरंगी सलाम में आप अपने मन मुताबिक विषय और क्षेत्र में कार्य करने के लिए स्वतंत्र होंगे।</p><br/>
        <p class="highlight">हम आपको सर्टिफिकेट भी प्रदान करते हैं।</p><br/>
        <p>जो लोग कम से कम 6 महीने तक सतरंगी सलाम से जुड़े रहेंगे, हम उन्हें एक प्रमाणपत्र भी प्रदान करेंगे।</p><br/>
        <p>और उत्कृष्ट कार्य करने वाले लोगों को अलग से प्रमाणपत्र जारी किया जाएगा।</p>
    </div>
    </div>
          </section>
        <footer>
