...
<meta property="og:title" content="Donate for Humanity">
<meta property="og:description" content="Donate for Our Cause at Satrangi Salaam">
...
<meta property="og:url" content="https://satrangisalaam.in/donate">
        <title>Donate</title>
...
<img class="qr" src="img/qr.jpg" alt="qr code" style="border-radius: 8px;">
<h2>UPI Id:</h2>
...
<div class="form-container">
  ...
  <form action="includes/submit_donation" method="POST">
    ...
    <div class="form-group">
      <label for="whatsapp"><b>Whatsapp Number:</b></label>
      <input type="number" id="whatsapp" name="whatsapp" placeholder="आपका व्हाट्सएप नंबर" name="whatsapp" required>
    </div>
