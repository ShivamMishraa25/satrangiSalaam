...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO experience (name, period, post, email, whatsapp, status) VALUES ('$name', '$period', '$post', '$email', '$whatsapp', 'pending')";
    mysqli_query($conn, $query);

    // Redirect to a thank-you page or home page
    header("Location: ../includes/thankYou_form");
}
?>
...
<meta property="og:title" content="Experience Certificate Form">
<meta property="og:description" content="Apply for your Certificate of Experience with Satrangi Salaam">
...
<!--  <meta property="og:url" content="http://satrangisalaam.in">  -->
        <title>Experience Certificate Form</title>
    ...
    <body>
        ...
        <img id="bird2" src="../img/bird2.png" alt="flying bird">
          <section class="content">
            <h3 class="section-title">Fill This Form To Get Your Experience Certificate</h2>
                <form id="container" class="left" method="POST">
    <label for="name">Name:</label>
    <input type="text" name="name" required><br>

    <label for="period">Period:</label>
    <input type="text" name="period" placeholder="eg. May 2024 - Sep 2024" required><br>

    <label for="post">Post:</label>
    <input type="text" name="post" placeholder="eg. Member" required><br>
...
<p class="left">Once your form is approved, you will recieve your Experience Certificate in digital format.</p>
          </section>
        <footer>
            <ul>
