...
<p class="highlight">हमें बताते हुए खुशी हो रही है कि सतरंगी सलाम व सहयोगियों - समर्थकों के अथक प्रयास के कारण धीरे-धीरे ही सही सकारात्मक बदलाव देखने को मिल रहा है।</p>

<ol>
    <li>
        <p> <strong>16 जून के इवेंट</strong> के कारण प्रयागराज व आस-पास के युवा समाज व मानवता के लिए कुछ करना चाह रहे हैं।<br>
        समाज में समलैंगिकों के प्रति व्याप्त गलत धारणा टूट रही है।<br>
        <span class="highlight">किसी को मात्र उसके Sexual Orientation या लिंग के आधार पर नहीं देखना चाहिए।</span>
        </p>
    </li>

    <li>
        <p>लोग अपने कपड़ों को इधर-उधर फेंकने के बजाय, खुद उसे जरूरतमंदों तक पहुँचा रहे हैं या फिर वे हमसे संपर्क करते हैं।</p>
    </li>

    <li>
        <p>बड़े अफसोस की बात है कि एक तरफ खाने की इतनी बर्बादी होती है, तो वहीं दूसरी तरफ भारत भुखमरी इंडेक्स में काफी पीछे है।<br>
        हम <span class="highlight">एक ऐसे सिस्टम</span> की मांग कर रहे हैं कि लोग अपने बचे हुए खाने को जरूरतमंदों तक पहुँचा सकें।
        </p>
    </li>

    <li>
        <p><strong>SAGA: Connecting The Dots</strong> इवेंट ने समाज के सभी वर्गों को एक साथ जोड़ने के दिशा में एक बहुत बड़ा रोल निभाया।</p>
    </li>

    <li>
        <p><strong>Discover & Accept Yourself</strong> इवेंट ने अधिकारियों व सम्पूर्ण समाज को LGBTQIA+ Rights के दिशा में सोचने पर मजबूर किया और नगर निगम ने इस दिशा में कई कदम उठाने का वादा किया।</p>
    </li>

    <li>
        <p>हमारे प्रयासों से महाकुंभ को प्लास्टिक मुक्त करने की <span class="highlight">एक मुहिम</span> चल रही है, जिसमें हमें दूसरे संस्थाओं आदि का भी समर्थन मिल रहा है।</p>
    </li>

    <li>
        <p>फ्री नेत्र जाँच शिविर से पता चला कि मोतियाबिंद एक गम्भीर समस्या बन रहा है, लेकिन लोग जागरूकता के अभाव में इसकी जाँच नहीं करवाते हैं और कई अस्पतालों द्वारा भी लापरवाही की जाती है।</p>
    </li>

    <li>
        <p><strong>Anti Rape प्रदर्शन</strong> के द्वारा अधिकारी व पूरा सिस्टम ये सोचने पर मजबूर हुआ कि रेप जैसे अपराधों का भी कोई लिंग या Sexual Orientation नहीं होता है।<br>
        <span class="highlight">रेपिस्टों का भी कोई लिंग, जाति धर्म या Sexual Orientation नहीं होता है।</span> रेप पुरुष, महिला, ट्रांस या जानवर किसी के साथ भी हो सकता है।<br>
        <strong>BNS</strong>, ट्रांस एक्ट व सम्बंधित कानूनों में बदलाव की आवश्यकता है।</p>
    </li>

    <li>
        <p>हम अगर किसी भी मुद्दे को उठाते हैं या कोई भी इवेंट करते हैं, तो हमारा मकसद बदलाव होता है और जब तक बदलाव नहीं होता है, हम लगे रहते हैं।</p>
    </li>

    <li>
        <p>हम योग व इससे जुड़े क्षेत्रों में भी काम कर रहे हैं।<br>
        <strong>सतरंगी सलाम</strong> के अथक प्रयास से आज लोग आयुष व योग के प्रति और रुचि ले रहे हैं।</p>
    </li>
</ol>
          </section>
        <footer>
