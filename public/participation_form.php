...
<meta property="og:title" content="Participation Certificate Form">
<meta property="og:description" content="Apply for your Certificate of Participation with Satrangi Salaam">
...
<!--  <meta property="og:url" content="http://satrangisalaam.in">  -->
        <title>Participation Certificate Form</title>
    ...
    <body>
        ...
        <img id="bird2" src="../img/bird2.png" alt="flying bird">
          <section class="content">
            <h3 class="section-title">Fill This Form To Get Your Participation Certificate</h2>
                <form id="container" class="left" action="../includes/submit_participation.php" method="POST">
    <label for="name">Name:</label>
    <input type="text" name="name" placeholder="आपका नाम" required><br>

    <label for="period">Event Name:</label>
    <input type="text" name="event_name" placeholder="कार्यक्रम का नाम लिखिए ॥ "><br>

    <label for="post">Event Date:</label>
    <input type="date" name="event_date" placeholder="कार्यक्रम की तारीक"><br>

    <label for="whatsapp">Mob Number:</label>
    <input type="text" name="whatsapp" placeholder="Whatsapp Number" required><br>

    <label for="email">Email:</label>
    <input type="email" name="email" placeholder="आपका ईमेल @gmail.com" required><br>

    <input class="button" type="submit" value="Submit">
</form>

<br><br>
<p class="left">We need your Whatsapp number and email to send your certificate to you.</p>

<p class="left">Once your form is approved, you will recieve your Participation Certificate in digital format.</p>
          </section>
        <footer>
            <ul>
