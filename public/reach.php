    ...
    <body>
        ...
        <img id="bird2" src="../img/bird2.png" alt="flying bird">
          <section class="content">
                <h1 class="section-title">प्रदेश व विभिन्न स्तर पर हम</h1>
    <br>
    <p class="left">आवश्यकतानुसार व सुविधानुसार भारत के किसी भी कोने में इसकी शाखा खोली जा सकेगी</p>
    <br>
    <p class="left">ट्रस्ट अपना सभी राज्यों, महानगरों, जिलों, ब्लॉक, शैक्षणिक संस्थानों आदि स्तरों पर टीमों का गठन कर सकेगा ।</p>
    <br>
    <p class="left">हम लगातार हर जगह के टीम का गठन कर रहे है और कई जगहों पर अपना कार्य शुरू कर चुके है ... जल्द ही वेबसाइट पर भी अपडेट किया जाएगा ।</p>
          </section>
        <footer>
            <ul>
